...
_ASSERT_INFO_FUNC assert_functions[] = {
	AIF(0x00404D60,0x00404DEA,NULL),
	...
	AIF(0x00420A10,0x00420A97,NULL),
	AIF(0x00420BD0,0x00420D0C,NULL),
	AIF(0x00420D50,0x00420F56,"stanceAnimRelatedSub"),
	AIF(0x00421390,0x004218EF,NULL),
	...
	AIF(0x00424900,0x00424AD6,NULL),
	...
	AIF(0x00429D50,0x0042A098,NULL),
	AIF(0x0042A0A0,0x0042A611,"RockMeter?"),
	AIF(0x0042A660,0x0042AD8B,NULL),
	...
	AIF(0x00439FA0,0x0043A058,NULL),
	AIF(0x0043B4A0,0x0043B51F,"MC_SetActiveFolder"),
	AIF(0x004676E0,0x0046791B,NULL),
	...
	AIF(0x00479160,0x004791E8,NULL),
	AIF(0x00479330,0x00479451,"QbKvPairList::GetValue2"),
	AIF(0x00484310,0x00484B0A,"?MainLoop@Manager@Mlp@@QAEXXZ"),
	AIF(0x004A90B0,0x004A92A3,NULL),
	AIF(0x004AA710,0x004AA8C1,NULL),
	AIF(0x004AB970,0x004ABA54,NULL),
	AIF(0x004ACF80,0x004ACFED,NULL),
	AIF(0x004ACFF0,0x004AD0CF,NULL),
	AIF(0x004B4C10,0x004B4D24,NULL),
	AIF(0x004BC770,0x004BCA78,NULL),
	AIF(0x004BE900,0x004BEB23,NULL),
	AIF(0x004C73B0,0x004C741F,NULL),
	AIF(0x004C7420,0x004C7497,NULL),
	AIF(0x004CFB70,0x004CFCF0,NULL),
	AIF(0x004FBEC0,0x004FC482,NULL),
	AIF(0x00516740,0x005168C6,NULL),
	...
	AIF(0x00546930,0x005469A9,NULL),
	AIF(0x00548E50,0x00548F88,"LoadFSB"),
	AIF(0x00550D10,0x00550D8A,"CreateVie"),
	AIF(0x0055A380,0x0055A550,NULL),
	AIF(0x0055BC70,0x0055BD16,NULL),
	AIF(0x0055C6A0,0x0055CB11,NULL),
	AIF(0x0055CF80,0x0055D266,NULL),
	AIF(0x0055DAE0,0x0055DD0C,NULL),
	AIF(0x00570DD0,0x005712E1,NULL),
	AIF(0x0057E3D0,0x0057E600,NULL),
	AIF(0x0057E6B0,0x0057E752,NULL),
	AIF(0x0057E900,0x0057EA9A,NULL),
	AIF(0x0057EAA0,0x0057EC35,NULL),
	AIF(0x0057EC40,0x0057ED52,NULL),
	AIF(0x0057ED60,0x0057EE86,NULL),
	AIF(0x0057EF00,0x0057F1CB,NULL),
	AIF(0x005D68F0,0x005D6B0D,NULL),
	AIF(0x005DA0F0,0x005DA550,NULL),
	AIF(0x005E64A0,0x005E6570,NULL),
	AIF(0x005E6730,0x005E67DD,NULL),
	AIF(0x005E8710,0x005E877C,NULL),
	AIF(0x005F5790,0x005F58DF,NULL),
	AIF(0x0060B890,0x0060B93E,NULL),
	AIF(0x0060B9C0,0x0060BA24,"locksAndGoalsSub"),
	AIF(0x00D7B40B,0x00D7B437,NULL),
	AIF(0x00D7B458,0x00D7B484,NULL),
	AIF(0x00D7BF0F,0x00D7BF3B,NULL),
	AIF(0x00D7E534,0x00D7E5E4,NULL),
	AIF(0x00D7E728,0x00D7E843,NULL),
	AIF(0x00D7EACD,0x00D7EB64,NULL),
	AIF(0x00D7EB8C,0x00D7EC46,"BossWaitForAttack"),
	AIF(0x00D7EC46,0x00D7EE86,NULL),
	AIF(0x00D7EE86,0x00D7F030,NULL),
	AIF(0x00D7F10C,0x00D7F235,NULL),
	AIF(0x00D7F235,0x00D7F261,NULL),
	AIF(0x00D7F54D,0x00D7F677,NULL),
	AIF(0x00D7F824,0x00D7F8CD,NULL),
	AIF(0x00D8B299,0x00D8B2E1,"?GetScript@CStruct@Script@@QBE_NVCChecksum@Crc@@PAUSStructScript@2@W4EAssertType@2@@Z"),
	AIF(0x00D8B2E1,0x00D8B361,NULL),
	AIF(0x00D8B36B,0x00D8B3EB,NULL),
	AIF(0x00D95F32,0x00D95FB2,NULL),
	AIF(0x00D96B78,0x00D96D3A,NULL),
	AIF(0x00D98A95,0x00D98B2C,NULL),
	AIF(0x00D9BDE1,0x00D9BEE4,NULL),
	AIF(0x00D9E7EE,0x00D9E949,NULL),
	AIF(0x00D9E949,0x00D9EA14,NULL),
	AIF(0x00D9F477,0x00D9F6B8,NULL),
	AIF(0x00DA5A21,0x00DA5A8E,NULL),
	AIF(0x00DA5A98,0x00DA5C61,NULL),
	AIF(0x00DAC4C5,0x00DAC500,NULL),
};
